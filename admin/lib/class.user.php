...
class USER
{
    ...
    public function register($umail,$upass,$repeatpass,$phone,$status,$role,$firstname,$lastname,$fbuserid = "")
    {
       try
       {
           if($upass != $repeatpass)
           ...
           $sql="INSERT INTO users(email,phone,pword,is_active,role,date_created,firstname,lastname,fb_user_id) 
                                                       VALUES(:umail, :phone, :upass, :status, :role, :date, :fname, :lname,:fb)";
           $fields=array(
               ':umail'=>$umail,
               ':phone'=>$phone,
               ':upass'=>$new_password,
