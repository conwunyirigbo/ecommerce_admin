...
function loadlocations(showloading) {
	if(showloading == 1)		
	document.getElementById('load').innerHTML='<img src="img/loading.gif"/>';
	var searchkey = document.getElementById('searchkey').value;
	var status =  document.getElementById('status').value;
	var strURL="../load/load_location.php?searchkey="+searchkey+"&status="+status;
...
function Delete(id)
{
	...
	{
    	var datastring = {'id':id,'delete':'location_list'};
    	$.ajax({
    	            type: "POST",
    	            	...
    	            	{       
    	            		...
    	            		setTimeout(function() {
    	                        toastr.options = {
    	                            closeButton: true,
    	                            progressBar: true,
    	                            locationClass: "toast-top-full-width",
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="row row-pad">
                                            ...
                                            <div class="col-md-6">
                                                <a href="location_setup" class="btn btn-success pull-right">Add New</a>
                                            </div>
                                        </div>
                                        <div class="row row-pad">
                                            <div class="col-md-12">
